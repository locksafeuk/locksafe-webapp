...
const FAMILY_COPY: Record<string, FamilyCopy> = {
  postcode_local: {
    headlines: [
      ...
      "Real Local · Fixed Price",
    ],
    descriptions: [
      "Locked out in {district}? DBS-checked local engineer. Fixed price agreed up front.",
  ...
  trust_signal: {
    ...
    descriptions: [
      ...
      "Tired of dodgy quotes? Real engineer, honest pricing, fixed quote up front. Call us.",
    ],
    extraNegatives: [],
    matchTypeMix:   ["PHRASE"],
  },
  ...
  service_long_tail: {
    ...
    descriptions: [
      ...
      "uPVC, Yale, anti-snap cylinders fitted. Local engineer, fixed price quote up front.",
    ],
...
const FALLBACK_COPY: FamilyCopy = {
  ...
  descriptions: [
    "DBS-checked local locksmith. Fixed price agreed before any work starts.",
