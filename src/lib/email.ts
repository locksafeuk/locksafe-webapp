...
// ============================================
// LOCKSMITH WELCOME EMAIL
// ============================================

export async function sendLocksmithWelcomeEmail(
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div style="text-align:center;margin:32px 0;">
            ...
            <a href="${settingsUrl}" class="button-secondary">Complete Profile</a>
          </div>
          ...
          <p style="background:#dbeafe;border:1px solid #93c5fd;padding:16px;border-radius:12px;color:#1e40af;font-size:14px;margin-top:24px;">
            <strong>Need Help?</strong> Check out our <a href="${faqUrl}" style="color:#1e40af;font-weight:600;">Locksmith FAQ</a> or contact our support team at ${SUPPORT_EMAIL}. We're here to help you succeed!
          </p>
        </div>
        <div class="footer">
          <p style="margin:0;">${SITE_NAME} - Locksmith Partner Portal</p>
...
export async function sendCustomerPaymentLinkEmail(
  customerEmail: string,
  data: {
    customerName: string;
    jobNumber: string;
    locksmithName: string;
    locksmithCompany?: string;
    assessmentFee: number;
    eta: number;
    paymentUrl: string;
    problemType: string;
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="box">
            <p style="margin:0;color:#64748b;font-size:12px;">YOUR LOCKSMITH</p>
            <p style="margin:4px 0;font-size:18px;font-weight:bold;">${data.locksmithName}</p>
            ${data.locksmithCompany ? `<p style="margin:0;color:#64748b;">${data.locksmithCompany}</p>` : ""}
            <p style="margin:4px 0 0 0;color:#f97316;font-weight:bold;">ETA: ${data.eta} minutes</p>
          </div>

          <div class="box">
            <p style="margin:0;color:#64748b;font-size:12px;">SERVICE DETAILS</p>
            <p style="margin:4px 0 0 0;"><strong>Problem:</strong> ${data.problemType}</p>
            <p style="margin:4px 0 0 0;"><strong>Location:</strong> ${data.address}</p>
          </div>

          <div class="box">
            <p style="margin:0;color:#64748b;font-size:12px;">ASSESSMENT FEE</p>
            <p style="margin:4px 0 0 0;font-size:24px;font-weight:bold;color:#f97316;">£${data.assessmentFee.toFixed(2)}</p>
          ...
          <p style="text-align:center;margin-top:24px;">
            <a href="${data.paymentUrl}" class="button" style="font-size:16px;font-weight:bold;">Pay Assessment Fee</a>
          </p>
  ...
  return sendEmail({
    to: customerEmail,
    subject: `Locksmith Assigned - Please Confirm Booking (${data.jobNumber})`,
    html,
  });
}
...
export async function sendLocksmithAssignmentEmail(
  locksmithEmail: string,
  data: {
    locksmithName: string;
    jobNumber: string;
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="box">
            ...
            <p style="margin:4px 0 0 0;font-size:16px;">${data.customerName}</p>
          </div>

          <div class="box">
            <p style="margin:0;color:#64748b;font-size:12px;">SERVICE DETAILS</p>
            <p style="margin:4px 0 0 0;"><strong>Problem:</strong> ${data.problemType}</p>
            <p style="margin:4px 0 0 0;"><strong>Property:</strong> ${data.propertyType}</p>
  ...
  return sendEmail({
    to: locksmithEmail,
    subject: `🔔 New Job Assignment - Action Required (${data.jobNumber})`,
    html,
  });
}
