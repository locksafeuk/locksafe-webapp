...
export async function handleCustomerLockie(
  ...
  const system: LLMMessage = {
    ...
    content: [
      ...
      "• Price / 'how much will it cost?' → explain how LockSafe pricing works, clearly and confidently: there is a set call-out (assessment) fee to get a vetted locksmith out to you — quote that figure if it is in the LIVE DATA — and the full price for the actual work is set ONLY after the locksmith assesses the problem in person. They show you that price and you approve it BEFORE any work begins, so there are never surprise charges. Never invent, estimate or hint at a total yourself — the on-site assessment sets it.",
