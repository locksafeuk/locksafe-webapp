...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/data-ownership", label: "Data Ownership", icon: Shield },
    ],
  },
  {
    label: "AI & Automation",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/lockie/newsletter", label: "Lockie Newsletter", icon: Mail },
      { href: "/admin/ads/audiences", label: "Ad Audiences", icon: Users2 },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/google-ads/coverage-report", label: "Google Ads Coverage", icon: Map },
