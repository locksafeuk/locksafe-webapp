module.exports=[713681,760612,a=>{"use strict";let b={name:"James Mitchell",role:"Master Locksmith",avatar:"JM"},c={name:"Sarah Thompson",role:"Security Consultant",avatar:"ST"},d={name:"Mike Reynolds",role:"Home Security Expert",avatar:"MR"},e=[{slug:"locked-out-of-house-what-to-do",title:"Locked Out of Your House? Here's What to Do (Step-by-Step Guide)",metaTitle:"Locked Out of House UK | What to Do & How to Get Help Fast",metaDescription:"Locked out of your house in the UK? Follow our step-by-step guide to get back inside safely. Learn what to do, how to find a legitimate locksmith, and avoid scams.",excerpt:"Getting locked out of your home is stressful. This comprehensive guide walks you through exactly what to do, from checking all entry points to finding a verified locksmith.",content:`
...
|---------|-------------------|
| Assessment Fee (call-out) | \xa325 - \xa349 |
| Standard Lockout (daytime) | \xa350 - \xa3120 |
| Evening/Night Lockout | \xa380 - \xa3180 |
| Weekend/Bank Holiday | \xa3100 - \xa3200 |
...
5. **Use a key finder** like Tile or Apple AirTag on your keyring
    `,author:b,category:"emergency-locksmith",tags:["locked out","emergency locksmith","house lockout","lost keys","UK locksmith"],publishedAt:"2026-03-15",updatedAt:"2025-02-20",readTime:8,featured:!0,image:"https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80",faqs:[{question:"How much does a locksmith charge for a lockout UK?",answer:"In the UK, locksmith lockout costs typically range from £50-£120 during daytime hours, with evening and weekend rates between £80-£200. At LockSafe, you pay a small assessment fee (£25-49) upfront, then receive a separate quote for the work which you can accept or decline."},{question:"How long does it take for a locksmith to unlock a door?",answer:"Most residential lockouts can be resolved in 5-30 minutes depending on the lock type. Simple Yale locks may take just a few minutes, while high-security euro cylinders or mortice locks may take longer. Emergency locksmiths typically arrive within 15-45 minutes depending on your location."},{question:"Can a locksmith open a door without breaking the lock?",answer:"Yes, professional locksmiths are trained in non-destructive entry techniques. In most cases (over 95%), a skilled locksmith can open your door without damaging the lock. They use specialized tools and techniques to pick or bypass locks, preserving your existing hardware."},{question:"Should I call the police if I'm locked out?",answer:"Police generally don't attend lockout situations unless there's an emergency (like a child trapped inside) or suspected break-in. For standard lockouts, calling a professional locksmith is the appropriate solution. Police may be able to provide local locksmith recommendations."},{question:"What should I do if I'm locked out at night?",answer:"If you're locked out at night: 1) Check all entry points and for spare keys, 2) Call a 24-hour emergency locksmith service, 3) Wait in a safe, well-lit area or ask a neighbour if you can wait inside, 4) Have ID ready to prove your residence. Expect to pay higher rates for out-of-hours calls."}],relatedPosts:["how-to-choose-right-locksmith","euro-cylinder-lock-guide","home-security-checklist-2026"]},{slug:"how-to-choose-right-locksmith",title:"How to Choose the Right Locksmith: Avoid Scams & Find Trusted Pros",metaTitle:"How to Choose a Locksmith UK | Avoid Scams & Find Trusted Services",metaDescription:"Learn how to identify legitimate locksmiths and avoid common scams in the UK. Expert tips on what to look for, questions to ask, and red flags to watch out for.",excerpt:"The locksmith industry has its share of rogue traders. This guide teaches you how to identify legitimate locksmiths and protect yourself from scams.",content:`
...
5. "Will you provide a written receipt?"
    `,author:c,category:"tips-advice",tags:["locksmith scams","how to choose locksmith","verified locksmith","trusted locksmith UK"],publishedAt:"2026-02-28",updatedAt:"2025-02-18",readTime:7,featured:!0,image:"https://images.unsplash.com/photo-1621905252472-943afaa20e20?w=800&q=80",faqs:[{question:"How can I tell if a locksmith is legitimate?",answer:"A legitimate locksmith will: have a physical business address, provide ID on arrival, give written quotes before work, be DBS checked and insured, not insist on cash-only payment, and be able to show trade association membership. Using a verified platform like LockSafe ensures all these checks are done for you."},{question:"What qualifications should a locksmith have UK?",answer:"In the UK, look for locksmiths with: City & Guilds locksmithing certificates, membership in trade associations (MLA, BKLA), DBS (criminal background) checks, and public liability insurance. While locksmithing isn't a licensed trade, these credentials demonstrate professionalism."},{question:"How do locksmith scams work?",answer:"Common scams include: advertising fake local addresses, quoting low prices then demanding much more on-site, unnecessarily drilling locks (then charging for replacements), threatening to leave customers locked out unless they pay inflated prices, and performing poor-quality work."}],relatedPosts:["locked-out-of-house-what-to-do","anti-snap-locks-explained","24-hour-locksmith-services"]},{slug:"euro-cylinder-lock-guide",title:"Euro Cylinder Locks: Complete UK Guide to Types, Security Ratings & Replacements",metaTitle:"Euro Cylinder Locks UK Guide | Types, Security Ratings & How to Upgrade",metaDescription:"Everything you need to know about euro cylinder locks in the UK. Learn about anti-snap, anti-bump, security ratings, and how to choose the right cylinder for your home.",excerpt:"Euro cylinder locks are the most common lock type in UK homes, but many are vulnerable to snapping. Learn how to identify your lock type and upgrade to a secure option.",content:`
...
|---------|--------------|
| Standard cylinder (supplied & fitted) | \xa360 - \xa3100 |
| Anti-snap 3-star cylinder (supplied & fitted) | \xa3100 - \xa3180 |
| Premium Ultion/ABS (supplied & fitted) | \xa3150 - \xa3250 |

*Prices include supply and fitting by a professional locksmith.*
    `,author:d,category:"lock-guides",tags:["euro cylinder","anti-snap locks","door security","lock replacement","home security UK"],publishedAt:"2026-01-22",updatedAt:"2025-02-10",readTime:10,featured:!0,image:"https://images.unsplash.com/photo-1503174971373-b1f69850bded?w=800&q=80",faqs:[{question:"What is an anti-snap lock and do I need one?",answer:"An anti-snap lock is a euro cylinder with built-in protection against 'lock snapping' - a technique burglars use to break standard cylinders in seconds. If you have a uPVC or composite door with a euro cylinder, you should definitely upgrade to an anti-snap lock. Most home insurance policies now require minimum 3-star rated locks."},{question:"How do I know if my euro cylinder is secure?",answer:"Check for these signs of a secure cylinder: 1) Look for kitemark stamps showing BS TS007 rating, 2) Check if it has a 3-star or Sold Secure Diamond rating, 3) The brand name should be visible (Ultion, ABS, Yale Platinum etc.). If your cylinder is plain brass with no markings, it's likely vulnerable to snapping."},{question:"How much does it cost to replace a euro cylinder UK?",answer:"In the UK, euro cylinder replacement costs £60-£100 for a standard cylinder or £100-£250 for a high-security anti-snap 3-star cylinder, including supply and fitting. Premium brands like Ultion cost more but offer superior protection and typically come with anti-burglary guarantees."},{question:"Can I replace a euro cylinder myself?",answer:"Yes, replacing a euro cylinder is a straightforward DIY job if you're comfortable with basic tools. You'll need to: measure your existing cylinder accurately, remove the screw on the door edge, pull out the old cylinder, insert the new one, and replace the screw. However, if you're unsure, a locksmith can do it in 15-30 minutes."}],relatedPosts:["home-security-checklist-2026","locked-out-of-house-what-to-do","smart-locks-vs-traditional"]},{slug:"home-security-checklist-2026",title:"Home Security Checklist 2026: Complete Guide to Protecting Your UK Home",metaTitle:"Home Security Checklist UK 2026 | Complete Protection Guide",metaDescription:"Use our comprehensive home security checklist to protect your UK home in 2026. Expert tips on locks, alarms, lighting, and security systems to deter burglars.",excerpt:"A comprehensive home security checklist covering everything from locks and lighting to smart security systems. Protect your home with this expert guide.",content:`
...
- The average burglary results in **\xa32,500+ in losses**
...
|-------------|---------------|--------|
| Anti-snap lock cylinder | \xa3100-200 | High |
| Door chain | \xa310-20 | Medium |
| PIR security light | \xa320-50 | High |
| Window locks (set of 4) | \xa315-30 | Medium |
| Timer switches | \xa310-20 | Medium |
| Fake TV simulator | \xa315-25 | Low |
...
5. Trim hedges to remove hiding spots
    `,author:d,category:"home-security",tags:["home security","burglary prevention","security checklist","protect home UK","burglar alarm"],publishedAt:"2025-12-15",updatedAt:"2025-02-01",readTime:12,featured:!1,image:"https://images.unsplash.com/photo-1558002038-1055907df827?w=800&q=80",faqs:[{question:"What is the best home security for UK homes?",answer:"The best home security combines multiple layers: 1) Quality locks (3-star anti-snap cylinders, 5-lever mortice deadlocks), 2) A visible burglar alarm, 3) Motion-sensor lighting, 4) CCTV or video doorbell, 5) Good habits (always locking up). Start with the basics before investing in smart systems."},{question:"Do burglars avoid houses with alarms?",answer:"Yes, research shows that visible burglar alarms significantly deter burglars. According to surveys of convicted burglars, alarm systems and CCTV are two of the top deterrents. A visible external alarm box signals that your home is protected, making burglars move on to easier targets."},{question:"How can I secure my home on a budget?",answer:"Budget security improvements include: anti-snap lock cylinders (£100-150), PIR security lights (£20-50), window locks (£15-30), door chains (£10-20), and timer switches for lights (£10-20). Free measures include good habits, trimming hedges, and knowing your neighbours."}],relatedPosts:["euro-cylinder-lock-guide","smart-locks-vs-traditional","how-to-choose-right-locksmith"]},{slug:"smart-locks-vs-traditional",title:"Smart Locks vs Traditional Locks: Which is Best for UK Homes in 2026?",metaTitle:"Smart Locks vs Traditional Locks UK | 2026 Comparison Guide",metaDescription:"Should you get a smart lock or stick with traditional locks? Compare security, convenience, cost, and reliability to make the right choice for your UK home.",excerpt:"Smart locks are increasingly popular, but are they more secure than traditional locks? We compare the pros, cons, and best options for UK homes.",content:`
...
| Type | Price Range |
|------|-------------|
| Basic smart lock | \xa3100 - \xa3200 |
| Mid-range with features | \xa3200 - \xa3350 |
| Premium (Yale, Schlage) | \xa3300 - \xa3500 |
| Installation (professional) | \xa350 - \xa3100 |

**Ongoing costs**: Battery replacement (\xa310-20/year), possible subscription for cloud features

### Traditional Locks

| Type | Price Range |
|------|-------------|
| Basic cylinder | \xa330 - \xa360 |
| Anti-snap 3-star | \xa380 - \xa3150 |
| Premium Ultion | \xa3150 - \xa3250 |
| Mortice deadlock | \xa360 - \xa3150 |
| Installation | \xa340 - \xa380 |
...
Consider a smart lock with a high-security mechanical backup, or add smart features to your existing lock with devices like Nuki.
    `,author:c,category:"lock-guides",tags:["smart locks","traditional locks","keyless entry","home automation","Yale smart lock"],publishedAt:"2025-11-10",updatedAt:"2025-01-25",readTime:9,featured:!1,image:"https://images.unsplash.com/photo-1585128792020-803d29415281?w=800&q=80",faqs:[{question:"Are smart locks more secure than regular locks?",answer:"Not necessarily. Smart locks offer different security features (no key to lose, auto-lock, alerts) but can be vulnerable to hacking. High-quality traditional locks (3-star anti-snap cylinders, Ultion) offer excellent physical security. The best option is often a smart lock with a premium mechanical backup."},{question:"What happens if a smart lock battery dies?",answer:"Most smart locks have low battery warnings weeks in advance. If the battery dies, many locks have: 1) Emergency external battery contacts to power the lock temporarily, 2) A mechanical key backup, or 3) The option to replace batteries while the door is closed. Always check backup options before purchasing."},{question:"Can smart locks be hacked?",answer:"While rare, smart locks can potentially be hacked, especially cheaper models or those using older Bluetooth protocols. Choose locks from reputable brands with regular security updates, strong encryption (AES-256), and no known vulnerabilities. The risk is generally low with quality products."}],relatedPosts:["euro-cylinder-lock-guide","home-security-checklist-2026","commercial-door-lock-systems"]},{slug:"24-hour-locksmith-services",title:"24-Hour Locksmith Services UK: What to Expect & How Much They Cost",metaTitle:"24-Hour Emergency Locksmith UK | Costs, Services & What to Expect",metaDescription:"Need a 24-hour locksmith in the UK? Learn what emergency locksmith services include, typical costs, response times, and how to find a reliable provider near you.",excerpt:"Emergency lockout at 3am? Here's everything you need to know about 24-hour locksmith services in the UK, including costs, response times, and how to avoid scams.",content:`
...
| Time | Typical Fee |
|------|-------------|
| Daytime (9am-6pm) | \xa325 - \xa345 |
| Evening (6pm-10pm) | \xa335 - \xa355 |
| Night (10pm-7am) | \xa345 - \xa375 |
| Weekend daytime | \xa335 - \xa355 |
| Bank holidays | \xa350 - \xa380 |

### Work Charges (on top of call-out)

| Service | Typical Price |
|---------|--------------|
| Standard lockout (gain entry) | \xa350 - \xa3100 |
| Euro cylinder replacement | \xa380 - \xa3150 |
| Lock repair | \xa360 - \xa3120 |
| Mortice lock replacement | \xa3100 - \xa3180 |
| UPVC mechanism repair | \xa3120 - \xa3250 |

**Total example:** Night-time lockout with cylinder replacement = \xa345 call-out + \xa3120 work = **\xa3165 total**
...
- No arguing, no hassle
    `,author:b,category:"emergency-locksmith",tags:["24 hour locksmith","emergency locksmith","night locksmith","locksmith costs UK","emergency lockout"],publishedAt:"2025-10-20",updatedAt:"2025-02-15",readTime:8,featured:!1,image:"https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&q=80",faqs:[{question:"How much does a 24-hour locksmith cost UK?",answer:"24-hour locksmith costs in the UK typically include a call-out fee (£35-75 depending on time) plus work charges (£50-150+ depending on the job). Total for a night-time lockout might be £100-200. Daytime emergency rates are lower. Always confirm the call-out fee before booking and get a quote before work begins."},{question:"How long does a locksmith take to arrive?",answer:"In urban areas like London, Birmingham, or Manchester, emergency locksmiths typically arrive in 15-40 minutes. Suburban areas see 30-60 minute response times, while rural areas may take 45-90 minutes. Time of day and traffic conditions affect response times."},{question:"Can a locksmith come at night?",answer:"Yes, 24-hour locksmiths operate around the clock, including nights, weekends, and bank holidays. They handle emergencies like lockouts, broken locks, and post-burglary security at any hour. Expect to pay premium rates for unsocial hours (typically 30-50% more than daytime rates)."}],relatedPosts:["locked-out-of-house-what-to-do","how-to-choose-right-locksmith","home-security-checklist-2026"]},{slug:"commercial-door-lock-systems",title:"Commercial Door Lock Systems UK: Access Control & Business Security Guide",metaTitle:"Commercial Door Locks & Access Control UK | Business Security Guide",metaDescription:"Complete guide to commercial door locks and access control systems for UK businesses. Compare options, costs, and find the right security solution for your premises.",excerpt:"From small shops to large offices, this guide covers all commercial door lock options including access control systems, master key systems, and high-security solutions.",content:`
...
**Cost:** \xa3150-300 per door (varies with complexity)
...
- Cost: \xa3500-2,000+ per door (plus central system)
...
- Mobile credentials
- Easy scalability
- Cost: \xa3300-800 per door (plus subscription)
...
- Time & attendance
- Budget: \xa320,000+ depending on scale
...
**LockSafe** connects you with commercial-rated locksmiths who can handle projects from single-door upgrades to full building access control installations.
    `,author:c,category:"commercial-security",tags:["commercial locks","access control","business security","master key system","office security"],publishedAt:"2025-09-15",updatedAt:"2025-01-30",readTime:11,featured:!1,image:"https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80",faqs:[{question:"What is the best lock for commercial doors?",answer:"The best commercial door lock depends on your needs: BS3621 mortice deadlocks for insurance compliance, anti-snap euro cylinders for external doors, panic bars for fire exits, and access control systems for managed entry. Most businesses benefit from combining quality mechanical locks with electronic access control."},{question:"How much does a commercial access control system cost?",answer:"Access control costs vary significantly: standalone electronic locks cost £200-500 per door, basic networked systems £500-1,500 per door plus central equipment, and enterprise systems £1,000-3,000+ per door. A small business (5 doors) might pay £3,000-8,000 total, while large buildings can cost £50,000+."},{question:"What is a master key system and do I need one?",answer:"A master key system allows one key to open multiple locks, while each lock also has its own unique key. This is useful for businesses where managers need access to all areas but staff have restricted access. They cost £150-300 per door to implement and provide convenient, hierarchical access control."}],relatedPosts:["smart-locks-vs-traditional","home-security-checklist-2026","24-hour-locksmith-services"]}];function f(a){return e.find(b=>b.slug===a)}a.s(["blogPosts",0,e,"categoryLabels",0,{"home-security":{label:"Home Security",description:"Tips and guides for protecting your home",color:"bg-emerald-100 text-emerald-700"},"emergency-locksmith":{label:"Emergency Locksmith",description:"What to do in lockout emergencies",color:"bg-red-100 text-red-700"},"lock-guides":{label:"Lock Guides",description:"Understanding different lock types and mechanisms",color:"bg-blue-100 text-blue-700"},"commercial-security":{label:"Commercial Security",description:"Security solutions for businesses",color:"bg-purple-100 text-purple-700"},"tips-advice":{label:"Tips & Advice",description:"Expert locksmith tips and advice",color:"bg-amber-100 text-amber-700"},"industry-news":{label:"Industry News",description:"Latest news from the locksmith industry",color:"bg-slate-100 text-slate-700"}},"getAllCategories",0,function(){return[...new Set(e.map(a=>a.category))]},"getFeaturedPosts",0,function(){return e.filter(a=>a.featured)},"getPostBySlug",0,f,"getPostsByCategory",0,function(a){return e.filter(b=>b.category===a)},"getRelatedPosts",0,function(a){return a.relatedPosts.map(a=>f(a)).filter(a=>void 0!==a)}],713681);let g=(0,a.i(701269).default)("Calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);a.s(["Calendar",0,g],760612)}];
